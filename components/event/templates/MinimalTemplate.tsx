        ...
        <div className="pt-10 lg:pt-20  max-w-4xl mx-auto">
          ...
          <div className="pb-8 grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <aside className="relative h-full">
              <div
                className={`p-6 border bg-zinc-50 space-y-6 lg:sticky lg:top-8 max-h-[calc(100vh-4rem)] overflow-y-auto ${borderRadiusClass}`}
              >
                {/* Date & Time */}
                {formattedDate && (
                      ...
                      {mounted && eventEndDate && (
                        <p className="text-xs  text-zinc-400 mt-0.5">
                          ...
                          <span className="font-medium text-zinc-700 text-sm">
                            {formatEndDate(eventEndDate)}{" "}
                            {eventEndDate && (
                              <span className="font-normal text-zinc-500 text-xs">
                                {" "}
                                <br /> {formatEventTime(eventEndDate)}
                              </span>
                            )}
                          </span>
                        </p>
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                {isFree
                                  ? "Free"
                                  : `${currency === "USD" ? "$" : "₦"}${tier.price.toLocaleString()}`}
                              </span>
                            </div>
                          );
                        })}
                  ...
                  {isExternal && externalUrl ? (
                    <div className="space-y-2">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            `${externalUrl}?utm_source=toastrelay&utm_medium=referral`,
                            "_blank",
                          )
                        }
                      >
                      ...
                      {[
                        ...
                        <button
                          ...
                          onClick={() =>
                            setRsvpValue(
                              "rsvpStatus",
                              status as RsvpFormValues["rsvpStatus"],
                            )
                          }
