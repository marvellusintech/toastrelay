...
export default function ModernWeddingTemplate({
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-stone-950 text-stone-100 font-serif selection:bg-rose-900 selection:text-white">
      <div className="flex-1">
        ...
        <main className="max-w-5xl mx-auto px-6 py-16 font-sans relative">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            <aside className="lg:col-span-1 relative h-full">
              <div
                className={`p-6 bg-stone-900/90 border border-stone-800/80 backdrop-blur-md space-y-6 lg:sticky lg:top-8 max-h-[calc(100vh-4rem)] overflow-y-auto ${activeBorderRadiusClass}`}
              >
